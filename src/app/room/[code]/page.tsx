              ...
              <div style={{ marginTop: "2rem" }}>
                {isHost ? (
                  ...
                  <div className="card" style={{ background: "var(--bg-card)", borderStyle: "dashed" }}>
                    <p>{room.isLoadingQuestions ? "PrÃ©paration de la partie..." : "Attente de l'hÃ´te..."}</p>
                  </div>
                )}
              </div>
            </div>
                ...
                {!myAnswer ? (
                  <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
                    ...
                    {(mode === "price" || mode === "both") && (
                      <div className="input-group">
                        <label style={{ fontWeight: "bold", display: "block", marginBottom: "0.5rem" }}>Prix estimÃ© ? (â‚¬)</label>
