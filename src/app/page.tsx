...
function HomeContent() {
  ...
  const handleCreateRoom = () => {
    ...
    const timeout = setTimeout(() => {
        alert("Impossible de se connecter au serveur. Le serveur est peut-ÃƒÂªtre en veille (Render). Attends 30 secondes et rÃƒÂ©essaie.");
    }, 20000);
  ...
  return (
    <div className="container">
      ...
      <div className="card" style={{ maxWidth: "500px", margin: "0 auto", width: "100%" }}>
        {mode === "menu" && (
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <button className="btn btn-secondary" onClick={() => setMode("create")}>
              <Users size={20} /> CrÃƒÂ©er une room
            </button>
        ...
        {mode === "solo_setup" && (
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            <h2 style={{ textAlign: "center" }}>ParamÃƒÂ¨tres Solo</h2>
        ...
        {mode === "create" && (
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            <h2 style={{ textAlign: "center" }}>CrÃƒÂ©er une room</h2>
            ...
            <button className="btn btn-secondary" onClick={handleCreateRoom}>CrÃƒÂ©er et inviter</button>
            <button className="btn btn-outline" onClick={() => setMode("menu")}>Retour</button>
          </div>
        )}
