  ...
  return (
    <div className="container">
      <div className="header">
        <div style={{ background: "red", color: "white", padding: "5px", textAlign: "center", fontWeight: "bold" }}>V1.5 - REPARATION</div><h1 className="title">Guess The <span>Review</span></h1>
